  ...
  return (
    <div className="page" style={{ padding: 24 }}>
      ...
      <div className="row" style={{ marginBottom: 12, gap: 4 }}>
        {["Overview","Joints (1842)","Documents","Timeline","Traceability","AI History"].map((t, i) => (
          <button key={t} className={`btn ${i === 1 ? "" : "ghost"} sm`}
                  style={{ background: i === 1 ? "var(--bg-3)" : "transparent" }}>
            {t}
          </button>
        ))}
        <span style={{ flex: 1 }}/>
              ...
              <tbody>
                {joints.map(j => (
                  <tr key={j.id}>
                    ...
                    <td>
                      <span className="mono" style={{ color: "var(--t-2)" }}>{j.welder}</span>
                    </td>
                ...
                return (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderBottom: "1px solid var(--border-1)", cursor: "pointer" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div className="mono" style={{ fontSize: 10.5, color: "var(--t-4)", letterSpacing: "0.06em" }}>
                        {d.kind} · {d.date}
                      </div>
                    </div>
    ...
    <div className="page">
      ...
      <div className="page-head">
        ...
        <div className="row" style={{ gap: 8 }}>
          ...
          <button className="btn primary sm"><Icons.Plus size={14}/> New project</button>
        </div>
      </div>
